...
/**
 * Class IncludeUnitsAvailable.
 */
class IncludeUnitsAvailable extends AbstractBooleanQueryParameter implements QueryParameterInterface
{
    public const KEY = 'includeUnitsAvailable';
}
